...
var mutations = {
  API_FAILURE: function API_FAILURE(state, error) {
    try {
      ...
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_4__.showError)(t('settings', 'An error occured during the request. Unable to proceed.') + '<br>' + message, {
        isHTML: true
      });
    } catch (e) {
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_4__.showError)(t('settings', 'An error occured during the request. Unable to proceed.'));
    }
...
var mutations = {
  ...
  setUserData: function setUserData(state, _ref9) {
...
var actions = {
   ...
   * @return {Promise}
   */
  getUsers: function getUsers(context, _ref10) {
  ...
  getGroups: function getGroups(context, _ref11) {
   ...
   * @return {Promise}
   */
  getUsersFromList: function getUsersFromList(context, _ref12) {
   ...
   * @return {Promise}
   */
  getUsersFromGroup: function getUsersFromGroup(context, _ref13) {
   ...
   * @return {Promise}
   */
  renameGroup: function renameGroup(context, _ref14) {
    var groupid = _ref14.groupid,
        displayName = _ref14.displayName;
    return _api__WEBPACK_IMPORTED_MODULE_0__["default"].requireAdmin().then(function (response) {
   ...
   * @return {Promise}
   */
  addUserGroup: function addUserGroup(context, _ref15) {
   ...
   * @return {Promise}
   */
  removeUserGroup: function removeUserGroup(context, _ref16) {
   ...
   * @return {Promise}
   */
  addUserSubAdmin: function addUserSubAdmin(context, _ref17) {
   ...
   * @return {Promise}
   */
  removeUserSubAdmin: function removeUserSubAdmin(context, _ref18) {
   ...
   * @return {Promise}
   */
  addUser: function addUser(_ref19, _ref20) {
    ...
    var userid = _ref20.userid,
        ...
        email = _ref20.email,
        groups = _ref20.groups,
        subadmin = _ref20.subadmin,
        quota = _ref20.quota,
   ...
   * @return {Promise}
   */
  enableDisableUser: function enableDisableUser(context, _ref21) {
   ...
   * @return {Promise}
   */
  setUserData: function setUserData(context, _ref22) {
