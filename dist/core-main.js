...
var Dialogs = {
  ...
  filepicker: function filepicker(title, callback, multiselect, mimetypeFilter, modal, type, path, options) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default().when(this._getFilePickerTemplate()).then(function ($tmpl) {
      ...
      self.$showGridView = jquery__WEBPACK_IMPORTED_MODULE_1___default()('input#picker-showgridview');
      self.$showGridView.on('change', underscore__WEBPACK_IMPORTED_MODULE_0__["default"].bind(self._onGridviewChange, self));
...
var setUp = function setUp() {
  Object.assign(_OC__WEBPACK_IMPORTED_MODULE_1__["default"], {
    setNavigationCounter: function setNavigationCounter(id, counter) {
      var appmenuElement = document.getElementById('appmenu').querySelector('[data-id="' + id + '"] svg');
      var appsElement = document.getElementById('apps').querySelector('[data-id="' + id + '"] svg');
  ...
  var $toggle = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#header .header-appname-container');
  var $navigation = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#navigation');
  var $appmenu = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#appmenu'); // init the menu
  ...
  $navigation.delegate('a', 'click', function (event) {
    var $app = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target);
    ...
    if (event.which === 1 && !event.ctrlKey && !event.metaKey && $app.attr('target') !== '_blank') {
      ...
      // a new tab
      _OC__WEBPACK_IMPORTED_MODULE_1__["default"].hideMenus(function () {
        return false;
      });
    }
  });
...
var resizeMenu = function resizeMenu() {
  var appList = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#appmenu li');
  var rightHeaderWidth = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.header-right').outerWidth();
  var headerWidth = jquery__WEBPACK_IMPORTED_MODULE_1___default()('header').outerWidth();
  var usePercentualAppMenuLimit = 0.67;
  var minAppsDesktop = 12;
  var availableWidth = headerWidth - jquery__WEBPACK_IMPORTED_MODULE_1___default()('#nextcloud').outerWidth() - (rightHeaderWidth > 210 ? rightHeaderWidth : 210);
  var isMobile = jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).width() < breakpointMobileWidth;

  if (!isMobile) {
    availableWidth = availableWidth * usePercentualAppMenuLimit;
  }

  var appCount = Math.floor(availableWidth / jquery__WEBPACK_IMPORTED_MODULE_1___default()(appList).width());
  ...
  for (var k = 0; k < appList.length - 1; k++) {
    var name = jquery__WEBPACK_IMPORTED_MODULE_1___default()(appList[k]).data('id');
...
var initCore = function initCore() {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('#navigation').length) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#header #nextcloud + .menutoggle').on('click', function () {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('#menu-css-helper').remove();
      var caretPosition = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.header-appname + .icon-caret').offset().left - 2;
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#header #appmenu .menutoggle').on('click', function () {
    ...
    switch (key) {
      ...
      case 'buttons':
        if (this.$buttonrow) {
          ...
          var $buttonrow = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="oc-dialog-buttonrow" />');
      ...
      case 'closeButton':
        if (value) {
          var $closeButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<a class="oc-dialog-close"></a>');
...
/******/ })()
;
//# sourceMappingURL=core-main.js.map?v=0cf475df8fc312e0a566