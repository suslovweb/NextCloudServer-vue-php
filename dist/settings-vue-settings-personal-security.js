...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    submit: function submit() {
      ...
      _nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_1___default()().then(function () {
        _this.loading = true;
        ...
        var server = window.location.protocol + '//' + window.location.host + (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.getRootUrl)();
  ...
  return !_vm.adding
    ? _c(
        ...
        [
          ...
          _c(
            "Button",
            { attrs: { disabled: _vm.loading }, on: { click: _vm.submit } },
            [
              _vm._v(
                "\n\t\t" +
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-personal-security.js.map?v=fb7c2d40787e7e9c1937